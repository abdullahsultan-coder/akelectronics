...
function addToCart(item){
  ...
  saveCart();
  renderCart();
  if (window.logAnalyticsEvent) window.logAnalyticsEvent("add_to_cart", { product_id: item.id });
}
...
function wireCartAndCheckout(){
  ...
  checkoutForm.addEventListener("submit", async e => {
    ...
    if (window.logAnalyticsEvent) window.logAnalyticsEvent("order_placed");
    ...
    if (notifyMethod === "whatsapp"){
      ...
      if (window.logAnalyticsEvent) window.logAnalyticsEvent("whatsapp_click");
